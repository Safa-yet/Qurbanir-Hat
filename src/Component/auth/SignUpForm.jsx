...
const SignUpForm = () => {
    ...
    return (
        <div className='relative'>
            <div className='relative h-screen md:h-[80vh]  lg:h-[120vh] '>
                <Image src={formBg} alt='Login Page Background' fill className='object-cover'></Image>
            </div>
      
            <div className='absolute top-0 flex items-center justify-center w-full md:h-[80vh] lg:h-[120vh]  h-screen inset-0 bg-black/50'>
                <div className='px-5'>
